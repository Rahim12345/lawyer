            ...
            <div class="card-body">
                <form method="post" action="{{ route('category.update',$category->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="category_az" value="{{ old('category_az',$category->category_az) }}" class="form-control" id="category_az" placeholder="Daşınmaz əmlak">
                            @error('category_az')
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="category_en" value="{{ old('category_en',$category->category_en) }}" class="form-control" id="category_en" placeholder="Real Estate Laws">
                            @error('category_en')
                            <small class="form-hint text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-footer">
                        <button type="submit" class="btn btn-primary float-end">{{ __('admin_master.update') }}</button>
                    </div>
                </form>
            </div>
        </div>
