...
@section('content')
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.vekiller.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="name" placeholder="Paz Conyers">
                            @error('name')
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="job" value="{{ old('job') }}" class="form-control" id="job" placeholder="Senior Attorney">
                            @error('job')
                            <small class="form-hint text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tel" value="{{ old('tel') }}" class="form-control" id="tel" placeholder="222 333 8800">
                            @error('tel')
                            <small class="form-hint text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" value="{{ old('email') }}" class="form-control" id="email" placeholder="Paz.Conyers@example.com">
                            @error('email')
                            <small class="form-hint text-danger">{{ $message }}</small>
                            @enderror
                        </div>
