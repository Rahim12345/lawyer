            ...
            <div class="card-body">
                <form method="post" action="{{ route('tag.update',$tag->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tag_az" value="{{ old('tag_az',$tag->tag_az) }}" class="form-control" id="tag_az" placeholder="Daşınmaz əmlak">
                            @error('tag_az')
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tag_en" value="{{ old('tag_en',$tag->tag_en) }}" class="form-control" id="tag_en" placeholder="Real Estate Laws">
                            @error('tag_en')
                            <small class="form-hint text-danger">{{ $message }}</small>
                            @enderror
                        </div>
