            ...
            <div class="card-body">
                <form method="post" action="{{ route('service.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="service_less_az" id="service_less_az" cols="30" rows="2"></textarea>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="service_less_en" id="service_less_en" cols="30" rows="2"></textarea>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="service_more_az" id="service_more_az" cols="30" rows="4"></textarea>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="service_more_en" id="service_more_en" cols="30" rows="4"></textarea>
...
@section('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            CKEDITOR.instances['service_more_az'].on("blur", function() {
                let version_az = CKEDITOR.instances['service_more_az'].getData();
                $.ajax({
                    type : 'POST',
                    data : {version_az},
                    url  : '{!! route('admin.service.translate.to.en') !!}',
                    success :function (response) {
                        CKEDITOR.instances['service_more_en'].setData(response);
                    },
                    error : function (myErrors) {
                        $.each(myErrors.responseJSON.errors,function (key, value) {
                            console.log(value);
