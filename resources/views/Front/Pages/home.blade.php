...
@section('content')
    <section class="slider-two">
        <div class="slider-one__carousel owl-carousel owl-theme">
            <div class="item slider-one__slide slide-two__slide slider-two__slider-1"
                 style="background-image: url({{ asset('assets/front') }}/images/slider/new-slider-2-1.jpg);"
                 data-thumb="{{ asset('assets/front') }}/images/slider/new-slider-2-1.jpg">
                <div class="container text-center">
                    ...
                    <div class="slider-two__btn-block">
                        <a href="#" class="thm-btn slider-two__btn">get started <i
                                class="fas fa-long-arrow-alt-right"></i></a><!-- /.thm-btn slider-two__btn -->
                        <a href="{{ route('front.services') }}"
                           class="thm-btn slider-two__btn slider-two__btn-two">{{ __('front_service.our_services') }} <i
                                class="fas fa-long-arrow-alt-right"></i></a><!-- /.thm-btn slider-two__btn -->
                    </div><!-- /.slider-two__btn-block -->
                </div><!-- /.container -->
            </div><!-- /.item -->
            <div class="item slider-one__slide slide-two__slide slider-two__slider-2"
                 style="background-image: url({{ asset('assets/front') }}/images/slider/new-slider-2-2.jpg);"
                 data-thumb="{{ asset('assets/front') }}/images/slider/new-slider-2-2.jpg">
                <div class="container text-center">
                    <p class="slider-two__tag-line">{{ __('front_about.most_successful_law_firm') }}</p>
                    <!-- /.slider-two__tag-line -->
                    <h2 class="slider-two__title">{{ __('front_service.effective_legal_solutions') }}</h2>
            ...
            <div class="item slider-one__slide slide-two__slide slider-two__slider-3"
                 style="background-image: url({{ asset('assets/front') }}/images/slider/new-slider-2-3.jpg);"
                 data-thumb="{{ asset('assets/front') }}/images/slider/new-slider-2-3.jpg">
                <div class="container text-center">
                    <p class="slider-two__tag-line">{{ __('front_about.most_successful_law_firm') }}</p>
                    <!-- /.slider-two__tag-line -->
                    <h2 class="slider-two__title">{{ __('front_service.effective_legal_solutions') }}</h2>
    ...
    <section class="case-three">
        <div class="container">
            <div class="block-title text-center">
                <p class="block-title__text-two">Culpa officia deserunt mollit animd laborum</p>
                <!-- /.block-title__text-one -->
                <h3 style="font-family: Arial"
                    class="block-title__title">{{ __('front_service.legal_practice_areas') }}</h3>
                <!-- /.block-title__title -->
            </div><!-- /.block-title -->
            <div class="row">
                        ...
                        <div class="case-three__single">
                            <div class="case-three__image">
                                <div class="case-three__image-inner">
                                    <img src="{{ asset('storage/service-covers/'.$service->cover) }}"
                                         alt="{{ app()->getLocale() == 'az' ? $service->service_name_az : $service->service_name_en }}"/>
                            ...
                            <div class="case-three__content">
                                <h3 class="case-three__title"><a
                                        href="#">{{ app()->getLocale() == 'az' ? $service->service_name_az : $service->service_name_en }}</a>
                                </h3><!-- /.case-three__title -->
                            {{ app()->getLocale() == 'az' ? $service->service_less_az : $service->service_less_en }}<!-- /.case-three__text -->
                                <a class="case-three__link"
                                   href="{{ route('front.single.services',$service->slug) }}"><span>{{ __('front_service.more_details') }}</span>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-7">
                    <div class="fact-two__top">
                        ...
                        <h3 class="fact-two__title">Developed a stronger commitment for people to make a difference by
                            our leading attorneys.</h3><!-- /.fact-two__title -->
                        ...
                        <div class="tab-content">
                            <div class="tab-pane animated fadeInUp show active" id="mission">
                                <p>Labore et dolore magna aliqu. Ut enim ad minim veniam quis nostrud exerci tation
                                    laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehende
                                    voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occae
                                    cupid atas non proident, sunt in culpa qui officia deserunt.</p>
    ...
    <section class="testimonials-two">
        <div class="container">
            <div class="thm__owl-carousel testimonials-two__carousel owl-carousel owl-theme"
                 data-options='{"loop": true, "margin": 75, "nav": false, "dots": true, "autoWidth": false, "autoplay": true, "smartSpeed": 700, "autoplayTimeout": 5000, "autoplayHoverPause": true, "responsive": {"0": {"items": 1 }, "480": {"items": 1 }, "600": {"items": 1 }, "991": {"items": 2 }, "1000": {"items": 2 }, "1200": {"items": 2 } } }'
                 data-carousel-prev-btn=".null" data-carousel-next-btn=".null">
                <div class="item">
                    <div class="testimonials-two__single">
                        ...
                        <div class="testimonials-two__content">
                            <p class="testimonials-two__text">Ipsum dolor sit amet, consecte stur adipisicing elit sed
                                eiusmod aduras minim veniam quis nostrud exercitation ullamco enim ad duis autey irure
                                dolor in reprehender voluptate sint occaecat cup non</p>
                            <!-- /.testimonials-two__text -->
                            <div class="testimonials-two__info">
                                <div class="testimonials-two__info-image">
                                    <div class="testimonials-two__info-image-inner">
                                        <img src="{{ asset('assets/front') }}/images/resources/testi-1-1.jpg"
                                             alt="Awesome Image"/>
                                    </div><!-- /.testimonials-two__info-image-inner -->
                                </div><!-- /.testimonials-two__info-image -->
                                <div class="testimonials-two__info-content">
                                    <h4 class="testimonials-two__info-name">John Benson</h4>
                                    <!-- /.testimonials-two__info-name -->
                                    <p class="testimonials-two__info-designation">Florida, USA</p>
        ...
        <section class="blog-one blog-one__home-two">
            <div class="container">
                <div class="block-title text-center">
                    ...
                    <p class="block-title__text-two">Sunt officia deserunt animd laborum perspicial</p>
                    <!-- /.block-title__text-one -->
                </div><!-- /.block-title -->
                <div class="row">
                    @if(app()->getLocale() == 'az')
                                ...
                                <div class="blog-one__single">
                                    <div class="blog-one__image">
                                        <div class="blog-one__image-inner">
                                            <img src="{{ asset('storage/blog-covers/'.$blog->photo) }}"
                                                 alt="{{ $blog->title_az }}"/>
                                            <a href="{{ route('front.single.blog',$blog->slug_az) }}"
                                               class="blog-one__image-link"><i class="fa fa-link"></i></a>
                                        </div><!-- /.blog-one__image-inner -->
                                    </div><!-- /.blog-one__image -->
                                    <div class="blog-one__content">
                                        <div class="blog-one__meta">
                                            <a href="{{ route('front.single.blog',$blog->slug_az) }}">Sanan
                                                Suleymanli</a>
                                        </div><!-- /.blog-one__meta -->
                                        <h3 class="blog-one__title"><a
                                                href="{{ route('front.single.blog',$blog->slug_az) }}">{{ $blog->title_az }}</a>
                                        </h3><!-- /.blog-one__title -->
                                        {!! substr($blog->title_az,0,50) !!}
                                        <div class="blog-one__bottom">
                                            <a class="blog-one__link"
                                               href="{{ route('front.single.blog',$blog->slug_az) }}"><span>{{ __('front_service.more_details') }}</span>
                                                <i class="fas fa-long-arrow-alt-right"></i></a>
                                            <a href="{{ route('front.single.blog',$blog->slug_az) }}"
                                               class="blog-one__share"></a>
                                ...
                                <div class="blog-one__single">
                                    <div class="blog-one__image">
                                        <div class="blog-one__image-inner">
                                            <img src="{{ asset('storage/blog-covers/'.$blog->photo) }}"
                                                 alt="{{ $blog->title_az }}"/>
                                            <a href="{{ route('front.single.blog',$blog->slug_en) }}"
                                               class="blog-one__image-link"><i class="fa fa-link"></i></a>
                                        </div><!-- /.blog-one__image-inner -->
                                    </div><!-- /.blog-one__image -->
                                    <div class="blog-one__content">
                                        <div class="blog-one__meta">
                                            <a href="{{ route('front.single.blog',$blog->slug_en) }}">Sanan
                                                Suleymanli</a>
                                        </div><!-- /.blog-one__meta -->
                                        <h3 class="blog-one__title"><a
                                                href="{{ route('front.single.blog',$blog->slug_en) }}">{{ $blog->title_en }}</a>
                                        </h3><!-- /.blog-one__title -->
                                        {!! substr($blog->title_en,0,50) !!}
                                        <div class="blog-one__bottom">
                                            <a class="blog-one__link"
                                               href="{{ route('front.single.blog',$blog->slug_en) }}"><span>{{ __('front_service.more_details') }}</span>
                                                <i class="fas fa-long-arrow-alt-right"></i></a>
                                            <a href="{{ route('front.single.blog',$blog->slug_en) }}"
                                               class="blog-one__share"></a>
                                        </div><!-- /.blog-one__bottom -->
                ...
                <div class="blog-one__more-block text-center">
                    <a href="{{ route('front.blog') }}"
                       class="thm-btn blog-one__more-btn">{{ __('front_master.view_all_blogs') }} <i
